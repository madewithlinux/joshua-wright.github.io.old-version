...
(defn st-export [colors]
  (str
    ...
    "\t/* 8 normal colors */\n"
    "\t[ 0] = \"#" (colors "ansi-black") "\", /* black   */ \n"
    "\t[ 1] = \"#" (colors "ansi-red") "\", /* red     */ \n"
    "\t[ 2] = \"#" (colors "ansi-green") "\", /* green   */ \n"
    "\t[ 3] = \"#" (colors "ansi-yellow") "\", /* yellow  */ \n"
    "\t[ 4] = \"#" (colors "ansi-blue") "\", /* blue    */ \n"
    "\t[ 5] = \"#" (colors "ansi-magenta") "\", /* magenta */ \n"
    "\t[ 6] = \"#" (colors "ansi-cyan") "\", /* cyan    */ \n"
    "\t[ 7] = \"#" (colors "ansi-white") "\", /* white   */ \n"
    "\t/* 8 bright colors */\n"
    "\t[ 8] = \"#" (colors "ansi-bright-black") "\", /* black   */ \n"
    "\t[ 9] = \"#" (colors "ansi-bright-red") "\", /* red     */ \n"
    "\t[10] = \"#" (colors "ansi-bright-green") "\", /* green   */ \n"
    "\t[11] = \"#" (colors "ansi-bright-yellow") "\", /* yellow  */ \n"
    "\t[12] = \"#" (colors "ansi-bright-blue") "\", /* blue    */ \n"
    "\t[13] = \"#" (colors "ansi-bright-magenta") "\", /* magenta */ \n"
    "\t[14] = \"#" (colors "ansi-bright-cyan") "\", /* cyan    */ \n"
    "\t[15] = \"#" (colors "ansi-bright-white") "\", /* white   */ \n"
    "\t/* special colors */\n"
